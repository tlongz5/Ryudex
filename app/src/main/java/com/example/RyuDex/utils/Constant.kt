...
object Constant {
    ...
    val POPULAR_TAGS = mapOf(
        ...
        "Web Comic" to "e197df38-d6e7-43be-9310-415f3b52cd08", //note
        "Comedy" to "4d32cc48-9f00-4cca-9b5a-a839f0764984",
        "Isekai" to "ace04997-f6aa-4bce-8d21-4b768fa42225", //note
        "Fantasy" to "cdc58593-87dd-415e-bbc0-2ec27bf404cc",
        "Full Color" to "f5ba408b-0e7a-484d-8d49-4e281ce1b1b2", //note
        ...
        "Martial Arts" to "799c202e-7daa-44eb-9ac7-8a3c0441ba3b", //note
        "Sports" to "69b626e9-b5f7-49f3-a7ce-0d5b79659424" //note
    )
}